 ...
 * on name and/or on URL of the license is working correctly.
 * @author Karl Heinz Marbaise
 *
 */
public class LicenseRealTest extends TestBase {
    ...
    public void beforeClass() throws IOException, XmlPullParserException {
        licensesContainer = LicensesFile.getLicenses(new File(getTestResourcesDirectory() + "licenses-real.xml"));
